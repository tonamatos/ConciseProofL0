...
\begin{abstract}
I give a new proof of the $L_0$ dichotomy for analytic graphs, based on Bernshteyn's recent proof of the $G_0$ dichotomy. Using a system of finite path approximations and a notion of smallness for families of homomorphisms, a canonical analytic graph of Borel chromatic number three is constructed. It is shown that every analytic graph of Borel chromatic number greater than two continuously admits this graph as a homomorphic image.
...
I denote the \emph{Borel chromatic number} of $G$ by $\chi_B(G)$, that is, $\chi_B(G)$ is the least number of colours $k$ needed to find a mapping $c:X\to k$ in such a way that adjacent vertices in $G$ are given different colours.
...
\section{Finite path approximations}
...
\begin{proof}[Proof of theorem]
    ...
    By Lemma~\ref{lemma:claim3.5}, there is a $G$-invariant Borel set $B_m\supseteq[\mathcal H_m]_{E_G}$ with a Borel 2-colouring $c_m$.
