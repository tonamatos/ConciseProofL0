...
\makeboxedtitle{A Concise Proof of the $L_0$ Dichotomy}{
    ...
    This brief note offers a new, substantially shorter proof of this result by adapting the graph-theoretic framework recently introduced by Bernshteyn for the $G_0$ dichotomy.
    The central device is a $\sigma$-ideal of small sets of homomorphisms from finite path approximations into the target graph, where smallness is witnessed by a bounded odd-walk condition on vertex projections.
...
I thank my doctoral advisor Spencer Unger for suggesting this project to me and for helpful discussions about the subject.
...
The goal of this section is to construct a family of graphs $\mathbb L_c$ indexed by $c\in\omega^\omega$.
